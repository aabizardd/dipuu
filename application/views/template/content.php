        ...
        <main>
            ...
            <div class="banner banner-home">
                ...
                <div id="rev_slider_279_1_wrapper" class="rev_slider_wrapper fullscreen-container"
                    ...
                    <div id="rev_slider_70_1" class="rev_slider fullscreenabanner" style="display:none;"
                        data-version="5.1.4">
                        <ul>
                            <li class="slider-color-schema-dark" data-index="rs-2" data-transition="fade"
                                ...
                                <img src="<?= base_url('assets/') ?>img/big-02.jpg" alt="image description"
                                    ...
                                    data-bgparallax="10" class="rev-slidebg" data-bgfit="cover" data-no-retina>
                                ...
                                <div class="slider-text text-white tp-caption tp-resizeme rs-parallaxlevel-2"
                                    ...
                                    data-fontweight="400" data-height="none" data-whitespace="normal"
                                    data-transform_idle="o:1;"
                                    data-transform_in="z:0;rX:0deg;rY:0;rZ:0;sX:1.5;sY:1.5;skX:0;skY:0;opacity:0;s:1500;e:Power3.easeInOut;"
                                    data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-mask_in="x:0px;y:0px;" data-mask_out="x:inherit;y:inherit;" data-start="1000"
                                ...
                                <div class="tp-caption rev-btn  rs-parallaxlevel-10" id="slide-163-layer-1"
                                    ...
                                    data-voffset="['320','60','240','220']" data-width="none" data-height="none"
                                    ...
                                    data-responsive_offset="on" data-paddingtop="[0,0,0,0]"
            ...
            <div class="content-wrapper">
                        ...
                        <div class="row multiple-row v-align-row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="col-wrap">
                                    <div class="ico-box bg-gray-light dark-hover">
                                        <div class="icon">
                                            <span class="custom-icon-font-design"><span
                ...
                <section class="content-block portfolio-block pt-0" id="container">
                    ...
                    <div class="row grid">
                        ...
                        <div class="gallery-item col-lg-4 col-md-6 ecommerce programming">
                            <figure class="picture-item img-block shine-effect image-zoom port-v2">
                                <img src="<?= base_url('assets/') ?>img/img-04.jpg" alt="images description">
                                <figcaption>
                                    <div class="link-box">
                                        <a href="#">
                                            <span class="icon-heart"><span class="sr-only">&amp;</span></span>
                        ...
                        <div class="gallery-item col-lg-4 col-md-6 programming ecommerce">
                            <figure class="picture-item img-block shine-effect image-zoom port-v2">
                                <img src="<?= base_url('assets/') ?>img/img-05.jpg" alt="images description">
                                <figcaption>
                                    <div class="link-box">
                                        <a href="#">
                                            <span class="icon-heart"><span class="sr-only">&amp;</span></span>
                        ...
                        <div class="gallery-item col-lg-4 col-md-6 ecommerce ui">
                            <figure class="picture-item img-block shine-effect image-zoom port-v2">
                                <img src="<?= base_url('assets/') ?>img/img-06.jpg" alt="images description">
                                <figcaption>
                                    <div class="link-box">
                                        <a href="#">
                                            <span class="icon-heart"><span class="sr-only">&amp;</span></span>
                ...
                <section class="content-block pt-0">
                    <div class="container">
                        <div class="block-heading bottom-space">
                            ...
                            <span class="block-sub-heading">View multiple content block layouts under features
                                section.</span>
                            <div class="divider"><img src="<?= base_url('assets/') ?>img/divider.png"
                                    alt="images description"></div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="bottom-space-small-only">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magnaal qua. Ut enim ad minim veniam, quis
                                        nostrud exercitation ulla mco laboris nisi ut aliquip ex ea commodo consequat.
                                    </p>
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culp a qui officia
                                        deserunt mollit anim id est laborum. Sed ut per spiciatis unde omnis iste natus
                                        error sit voluptatem accusan tium doloremque laudantium, totam rem aperiam,
                                        eaque ip </p>
                ...
                <section class="content-block count-block text-center p-0 parallax"
                    data-stellar-background-ratio="0.55">
                        ...
                        <div class="testimonial-container text-center">
                            <div class="owl-carousel testimonial-slide" id="waituk-owl-slide-3">
                                <div class="slide-item">
                                    <div class="team-wrap">
                                        <div class="img-block">
                                            <img src="<?= base_url('assets/') ?>img/people-01.jpg"
                                                alt="images description">
                                        </div>
                                        <div class="text-wrap">
                                ...
                                <div class="slide-item">
                                    <div class="team-wrap">
                                        <div class="img-block">
                                            <img src="<?= base_url('assets/') ?>img/people-02.jpg"
                                                alt="images description">
                                        </div>
                                        <div class="text-wrap">
                                            <h2>Jason Doe</h2>
                                ...
                                <div class="slide-item">
                                    <div class="team-wrap">
                                        <div class="img-block">
                                            <img src="<?= base_url('assets/') ?>img/people-03.jpg"
                                                alt="images description">
                                        </div>
                                        <div class="text-wrap">
                                            <h2>Jake Grahm</h2>
